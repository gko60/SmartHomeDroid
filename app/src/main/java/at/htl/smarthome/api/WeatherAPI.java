...
public class WeatherAPI {
    ...
    private static final String LOG_TAG = WeatherAPI.class.getSimpleName();

    /**
     * Liest per GET-Request Daten von einem Webserver aus.
     * Wird für REST und HTTP verwendet
     *
     * @param url URL des REST-Servers
    ...
    private static String httpGet(String url) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "httpGet(): " + e.getMessage());
        } finally {
            if (connection != null)
     ...
     *
     * @return HTML-Text für das aktuelle Wetter am aktuellen Ort
     */
